...
import { GradientButton, ButtonBorderGradient, ButtonCommon, icons, GroupButton } from "@tnbt/react-favorit-style"
...
export default function ButtonExample() {
  return (
    <div>
      ...
      <div className="my-2.5 font-[500] text-[18px] text-left">Group button</div>
