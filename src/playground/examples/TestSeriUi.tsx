...
import {ButtonCommon, AnimatedInfoModal, Notification} from "@tnbt/react-favorit-style"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="text-[26px] font-[700] text-left">3. Animation Modals</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {(Object.keys(animationConfigs) as AnimationType[]).map((key) => (
            <ButtonCommon key={key} onClick={() => setActiveAnimation(key)} className="w-full" variant="default">
