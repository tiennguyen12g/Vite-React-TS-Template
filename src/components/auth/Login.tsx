    ...
    <div className="w-full max-w-md mx-auto p-8 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center">
            ...
            />
            <span className="text-sm text-gray-700 dark:text-gray-300">{t("auth.login.rememberMe")}</span>
          </label>
          {onForgotPassword && (
            <button type="button" onClick={onForgotPassword} className="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
      ...
      {onSwitchToSignUp && (
        <div className="mt-4 text-center">
          <span className="text-sm text-gray-600 dark:text-gray-400">{t("auth.login.noAccount")} </span>
          <button
            type="button"
